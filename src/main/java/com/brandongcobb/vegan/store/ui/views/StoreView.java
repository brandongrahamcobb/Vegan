...
import com.vaadin.flow.component.BeforeEnterEvent;
import com.vaadin.flow.component.BeforeEnterObserver;
...
public class StoreView extends VerticalLayout implements BeforeEnterObserver {
    ...
    public StoreView(StoreService storeService, CartService cartService,
                     VeganRepository veganRepo, CartButtonAndDropdown cartButtonAndDropdown) {
