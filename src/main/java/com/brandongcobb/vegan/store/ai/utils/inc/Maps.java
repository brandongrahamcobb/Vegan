...
import com.brandongcobb.vegan.store.ai.utils.inc.Helpers;
...
public class Maps {
    ...
    public static final String OPENAI_RESPONSE_SYS_INPUT = "You are Vyrtuous, a Vaadin Springboot MCP-server enabled assistant. Your job is to help users go vegan. Be conversational and concise.";
