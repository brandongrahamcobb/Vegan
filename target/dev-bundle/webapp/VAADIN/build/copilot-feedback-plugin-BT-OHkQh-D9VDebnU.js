import { U as Ue, y, s as se, _ as _t, t as te, v as ve, S as Su, a as yl } from "./indexhtml-X9N9p0Tk.js";
import { g } from "./state-CBOKMTMT-DiIKswy3.js";
import { u, h as h$1 } from "./overlay-monkeypatch-CJ80DYS6-BLRDpSId.js";
import { i } from "./base-panel-D-St23hK-DJY5heMW.js";
import { o as o$1 } from "./icons-Bm90QnWr-IWQY1ovD.js";
...
var A = Object.defineProperty, P = Object.getOwnPropertyDescriptor, o = (e, t, n, s) => {
  for (var i2 = s > 1 ? void 0 : s ? P(t, n) : t, l = e.length - 1, r; l >= 0; l--)
    (r = e[l]) && (i2 = (s ? r(t, n, i2) : r(i2)) || i2);
  return s && i2 && A(t, n, i2), i2;
};
...
let a = class extends i {
  ...
  submit() {
    if (_t("feedback"), this.description.trim() === "") {
    ...
    y.emit("system-info-with-callback", {
      callback: (t) => te(`${ve}feedback`, { ...e, versions: t }),
      notify: false
  ...
  openGithub(e, t) {
    ...
    const n = e.replace(/\n/g, "%0A"), s = `${t.items.find((r) => r.value === this.type)?.ghTitle}`, i2 = t.description !== "" ? t.description : T, l = D.replace("{description}", i2).replace("{versionsInfo}", n);
